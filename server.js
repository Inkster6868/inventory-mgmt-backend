...
app.use(cors({
    origin:["http://localhost:3000", "https://Streamline-Stock.vercel.app"],   /* this will allow the cross origin to make request to this backend, the url we specify in origin are allowed to make req to backend */
